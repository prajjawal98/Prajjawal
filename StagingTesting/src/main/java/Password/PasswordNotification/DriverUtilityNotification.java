...
public class DriverUtilityNotification {
    static WebDriver driver;
    private HashMap<String, String> urlKeys;


    private DriverUtilityNotification() throws Exception {
    ...
    public boolean performTest(SheetColumn sheetColumn) throws InterruptedException, IOException {
        try {
            ...
            driver.findElement(By.cssSelector(urlKeys.get(OpenBrowser.ENTER_EMAIL1_KEY))).sendKeys(sheetColumn.getEmailId1());
            Thread.sleep(1000);
            ...
            driver.findElement(By.cssSelector(urlKeys.get(OpenBrowser.ENTER_USERNAME_KEY))).sendKeys(sheetColumn.getUsername());
...
/////////////////////////////////////////////////////////////////////////////////////////////
            ...
            String Password = emailText1.substring(143, 159);
            ...
            Thread.sleep(1000);
            driver.findElement(By.cssSelector(urlKeys.get(OpenBrowser.ENTER_EMAIL1_KEY))).clear();
            driver.findElement(By.cssSelector(urlKeys.get(OpenBrowser.ENTER_EMAIL1_KEY))).sendKeys(sheetColumn.getEmailId2());
            Thread.sleep(1000);
            //takeScreenshot("enteryopemail");
            driver.findElement(By.cssSelector(urlKeys.get(OpenBrowser.SEND_EMAIL1_BUTTON_KEY))).click();
            Thread.sleep(1000);
            driver.switchTo().frame("ifmail");
            Thread.sleep(1000);
            driver.findElement(By.cssSelector("#mailmillieu"));

            /////////////////////////////////////////////////////////
            //adding the assertion for last step of end to end test cases

            WebElement web4 = driver.findElement(By.xpath("//div[contains(text(),'Your Imprivata Security Update')]"));
            Thread.sleep(1000);
            String ActualTitle = web4.getText();
            System.out.println(ActualTitle);
            String ExpectedTitle = "Your Imprivata Security Update";
    ...
    public static DriverUtilityNotification getInstance() throws Exception {
        return new DriverUtilityNotification();
    }
